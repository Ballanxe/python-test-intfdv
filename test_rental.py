...
class TestBikeRental(unittest.TestCase):
    ...
    def test_errors(self):
        ...
        with self.assertRaises(ValueError) as context:
            ...
            self.assertTrue('Invalid family_member format'
            ...
            self.assertTrue('Start time has to be datetime instance'
                            in context.exception)
            ...
            self.assertTrue('Return date must be a datetime object' in
                            context.exception)
...
class TestFamilyRental(unittest.TestCase):
    ...
    def test_full_family_promotion(self):
        ...
        self.assertEqual(family_rent.get_total_price(),
                         expected_total_price)
